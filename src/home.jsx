			...
			<div className="z-[-19]">
				<div className="md:flex justify-between w-[90%] md:my-[200px]">
					...
					<div className="md:max-w-[600px] md:flex-row text-center md:text-xl md:mt-0 mt-[40px] md:ml-0 ml-3">
						<h1 className="font-bold md:text-4xl text-[#2f1793] text-2xl">
							252 Development
						</h1>
						<p className="pt-[15px] ml-3 text-gray">
				...
				<div id="why" className="md:my-0 my-8">
					<h1 className="text-2xl md:text-3xl font-bold text-[#2f1793] text-center">
						WHY CHOOSE <span className="text-[#2f1793]">252</span>
					</h1>
					<div className="p-5 flex flex-wrap  justify-center gap-5 mx-auto my-10">
						...
						<div className="bg-white w-[250px] md:my-0 my-3 p-4 rounded-md  mx-[3vw] border-[3px] border-transparent shadow-md duration-200 hover:border-[#2f1793]">
							<img
								className="md:w-12 w-10 mx-auto py-4"
								src={codelogo}
								alt=""
							/>
							<h1 className="text-[#2f1793] text-xl font-semibold text-center">
								Web development
							</h1>
						...
						<div className="bg-white w-[250px] md:my-0 my-3 p-4 rounded-md mx-[3vw] border-[3px] border-transparent shadow-md duration-100 hover:border-[#2f1793]">
							<img
								className="md:w-12 w-10 mx-auto py-4"
								src={codelogo}
								alt=""
				...
				{/* reduced width of the parent element to 95% and centered the div. */}
				<div className="w-[95%] mx-auto">
					<h1 className="my-5 text-2xl md:text-3xl font-bold text-[#2f1793] text-center">
						Our Bots
					</h1>
